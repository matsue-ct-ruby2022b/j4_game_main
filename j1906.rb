...
class Story
    ...
    def initialize
        ...
        [
          ...
          [
            "ある少年の夢を見た。",
            "\n\n少年はいつも通り少女と一緒に夕方まで遊び、\n\n「またね」と言って家に帰りました。",
            "\n\n\n\n家に帰ると、少年の両親と知らない男の人が少年の帰りを待っていました。",
            "\n\n\n\n彼の両親は今まで見たこともない笑顔で少年を迎え、知らない男は少年の方へ歩いてきました。",
            "\n\n\n\n\n\n???:「君はね、今年の魔王様へのイケニエに選ばれたんだよ。」",
            "\n\n\n\n\n\n少年:「イケニエってなあに？」",
            "\n\n\n\n\n\n???:「簡単に言うと、村の代表になって皆を護ることだよ。」",
            "\n\n\n\n\n\n\n\n少年はそれを聞いて誇らしい気持ちになっていました。",      
          ],
          [
            "???:「じゃあ、私はこれで。」",
            "そう言って男は立ち去りました。",
        ...
        [
          ...
          [
            "ある少年の夢を見た。",
            "\n\nイケニエとして捧げられる2日前、少年と両親は村を出る準備を完璧に済ませ、家を出ました。",
            "\n\n少年達は、出発から10分足らずで村を抜け出すことに成功し、\n\n1時間程村から離れるために歩き続けました。",
            "\n\n\n\n少年:「お父さん、疲れた。」",
          ...
          [
            "その直後、周りから大勢の兵士が現れ、少年たちを包囲していました。",
            "そして少年と母はあっけなく兵士の人たちに捕まってしまいました。",
            "兵士:「国王様に逆らった罰だ。」",
            "兵士はそう言って、母の首を剣ではねました。",
            "直後、少年は意識を失いました。",
            "\n\n\n\n\n少年が目を覚ましたとき、少年は裸で石の台の上にいました。",
            "\n\n\n\n\n\n\n???:「よお、お目覚めかい、少年。」",
          ],
        ],
        #4日目の終了
        [
          ...
          [
            "ある少年の夢を見た。",
            "\n\n少年が目を覚ました時、彼の隣には今にも消えてしまいそうなナニカがいました。",
          ...
          [
            ...
            "\n\n少年:「いいよ、僕の体を乗っ取って。その代わりちゃんとこらしめてよね。」",
            "\n\n魔王:「ああ、もちろん。それは保障しよう。」",
            "\n\n\n\n魔王:「では始めるぞ。」",
            "\n\n\n\n\n\nこうして少年の体は魔王のものになった。"
          ],
        ...
        [
          ...
          [
            "ある少年の夢を見た。",
            "\n\n少年の過ごす日々は地獄そのものだった。",
            "\n\n確かに魔王は少年が住んでいた村を焼き払い、そこから逃げた者は魔法で拘束しなぶり殺した。",
            "\n\n当然、その中にはあの少女もいた。",
            "\n\n\n\n少年:「もうやめて！！！！！！」",
            "\n\n\n\n\n\nそんな少年の叫びも外に聞こえることも、魔王の耳に届くことも無かった。",
            "\n\n\n\n\n\n少年は体を動かすこともできず、魔王が繰り広げる惨劇を見る事しかできない。",
          ],
          [
            "それからも魔王は他の村や国を滅ぼし続けました。",
            "人を殺して得られる経験値の快感も、少年にとってはただの拷問でしかありませんでした。",
            "そして、少年はその様を永遠と見続けるうち、\n\n全てを諦め、「殺してほしい」という思いだけを持つようになりました。",
          ]
        ],
        #6日目の終了
        [
          ...
          [
            "ある少年の夢を見た。",
            "\n\nある日、少年の前に、一人の男が現れました。",
            "\n\nその男は、今まで少年が見てきたどの兵士よりも強かった。",
            "\n\n少年は、「今度こそ殺してもらえる」と思い、目の前の戦いを見ていました。",
            "\n\nしかし、そんな男でも魔王を殺すには至りませんでした。",
            "\n\n激しい戦いの末、男は魔王を封印することに成功しました。",
            "\n\n少年は死ねなかった絶望と同時に、希望を持ちました。",
