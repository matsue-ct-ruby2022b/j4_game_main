...
#主人公
class Hero
  attr_accessor  :status, :is_escaped, :hero_type, :crt_page, :max_page, :level, :limit_turn, :hp, :power, :origin_power, :brain, :avoid, :origin_avoid, :is_def, :def, :origin_def, :before_def, :cri, :hp_max, :mp, :mp_max, :speed, :exp, :money, :need_exp, :clear, :endroll
  def initialize
    @level = 1
    @exp = 0
    @money = 10
...
Window.loop do
  ...
  Window.loop do
    ...
    #タイトル表示
    Window.draw_morph(300,0,724,0,724,400,300,400,title_name)
